 ...
 */
- (void)playerView:(nonnull YTPlayerView *)playerView didStateChanged:(YTPlayerState)state;
 ...
 */
- (void)playerView:(nonnull YTPlayerView *)playerView didQualityChanged:(YTPlaybackQuality)quality;
