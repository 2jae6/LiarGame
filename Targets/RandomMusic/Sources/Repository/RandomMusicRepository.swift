...
public protocol RandomMusicRepositoryType {
  /// 최신 버전을 확인합니다.
...
public final class RandomMusicRepository: RandomMusicRepositoryType {
  ...
  public var newestVersion: Single<String> {
    _newsetVersion
  ...
  private func setCurrent(version: String) {
    Self._currentVersion = version
  }

  /// 버전 확인 후 최신 버전을 가져옵니다.
  public func getNewestVersion() -> Single<(list: [Music], version: String)> {
    _newsetVersion
