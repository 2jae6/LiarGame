...
final class LiarGameSubjectViewController: UIViewController, View, FactoryModule {
  ...
  public struct Dependency {
    ...
    public init(reactorFactory: LiarGameSubjectReactor.Factory, liarGameFactory: LiarGameViewController.Factory) {
      self.reactorFactory = reactorFactory
      self.liarGameFactory = liarGameFactory
    }
  }
  ...
  struct Payload {
    ...
    public init(reactor: LiarGameSubjectReactor, mode: LiarGameMode, memberCount: Int) {
